...
KDJ中的J值，是由K和D的差值计算而来，当J到达低点，K和D的差值会变小，还记得K和D分别代表什么吗？RSV是一个反映当前价格与历史价格的相对位置的指标，当RSV接近100时，说明当前价格已经接近历史价格的最高点，当RSV接近0时，说明当前价格已经接近历史价格的最低点。

RSV描述了当前价格与历史价格的相对位置，而K和D则是RSV的平滑处理，是围绕RSV构建的双均线系统，既然是双均线，那么就必定是为了在交叉点寻找机会。当K和D的差值变小，说明RSV的相对位置变小，说明当前价格已经接近历史价格的最低点，此时可以考虑买入。而这个差值，加上代表权重的系数，就是J值。

当J到达低点时，说明RSV已经接近0，说明当前价格已经接近历史价格的最低点，此时可以考虑买入。这就是所谓J到大负值的逻辑，毕竟股价创新高/新低的概率很小。